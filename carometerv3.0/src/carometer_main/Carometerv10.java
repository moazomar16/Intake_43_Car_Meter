...
public class Carometerv10 extends Application implements  MapComponentInitializedListener {
    ...
    public static double Max_speed=30.00;
    
    private MarkerOptions markerOptions1;
    private Marker myPosition;
    public static Gauge gauge;
    public static Label longValue;
    public static Label alarmStatus;
    public static  Label speedValue;
    public static Label latValue;
...
//      FlowPane fp  = new FlowPane(); 
      ...
      latValue = new Label(Double.toString(LAT));
      ...
      gauge.setTickLabelOrientation(TickLabelOrientation.ORTHOGONAL);
       gauge.setThresholdColor(Color.RED);  //color will become red if it crosses threshold value
         gauge.setThreshold(Max_speed);
        gauge.setValue(Current_Speed);
      ...
      longValue = new Label(Double.toString(LNG));

...
public class Carometerv10 extends Application implements  MapComponentInitializedListener {
    ...
    public static double LAT =30.070824;
    public static double LNG= 31.021621;
...
//      FlowPane fp  = new FlowPane(); 
      ...
      Label latValue = new Label(Double.toString(LAT));
      ...
      Label speedValue = new Label(Double.toString(Current_Speed));
      ...
      Label longValue = new Label(Double.toString(LNG));
